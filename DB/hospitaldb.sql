...
MySQL - 5.7.18-log : Database - hospitaldb
*********************************************************************
*/
...
CREATE TABLE `medicine` (
  ...
  `salPrice` double DEFAULT NULL,
  `name` varchar(50) DEFAULT NULL,
  `type` int(11) DEFAULT NULL,
  `descs` varchar(200) DEFAULT NULL,
  `qualityDate` int(11) DEFAULT NULL,
  `description` varchar(500) DEFAULT NULL,
  `produceFirm` varchar(80) DEFAULT NULL,
  `readme` varchar(300) DEFAULT NULL,
